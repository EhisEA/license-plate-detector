...
def detectPlatesInScene(imgOriginalScene):
    ...
    if scanForPlateNumber.showSteps == True: # show steps #######################################################
    ...
    if scanForPlateNumber.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, scanForPlateNumber.SCALAR_WHITE)
    ...
    if scanForPlateNumber.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), scanForPlateNumber.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), scanForPlateNumber.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), scanForPlateNumber.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), scanForPlateNumber.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if scanForPlateNumber.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, scanForPlateNumber.SCALAR_WHITE)
        # end if # show steps #####################################################################
